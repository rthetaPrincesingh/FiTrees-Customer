...
class goalDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(goalDetailsScreenController());
    return Scaffold(
            ...
            children: [
              ...
              Obx(
                () => WheelSlider.customWidget(
                  ...
                  isVibrate: true,
                  onValueChanged: (val) {
                    controller.selectedGoalListIndex.value = val;
                  },
                  showPointer: true,
                  ...
                  children: List.generate(
                    controller.goalList.length,
                    (index) => Text(
                      controller.goalList[index],
                      style: GoogleFonts.openSans(
                        fontSize: (controller.selectedGoalListIndex.value == index &&
                            _nInitValue == index) || controller.selectedGoalListIndex.value == index
                            ? 28
                            : 24,
                        fontWeight: (controller.selectedGoalListIndex.value == index &&
                                _nInitValue == index) || controller.selectedGoalListIndex.value == index
                            ? FontWeight.w600
                            : FontWeight.w400,
                  ...
                  Align(
                    ...
                    child: IntrinsicWidth(
                      child: CupertinoButton(
                        ...
                        color: primaryColor,
                        onPressed: () => Get.to(activityLevelDetailsScreen()),
